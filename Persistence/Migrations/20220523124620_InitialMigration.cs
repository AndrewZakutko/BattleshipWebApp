    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    StartPositionX = table.Column<int>(type: "INTEGER", nullable: false),
                    StartPositionY = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CellShips_Cells_CellId",
                        column: x => x.CellId,
                        principalTable: "Cells",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CellShips_Fields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "Fields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CellShips_Ships_ShipId",
                        column: x => x.ShipId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CellShips_CellId",
                table: "CellShips",
                column: "CellId");

            migrationBuilder.CreateIndex(
                name: "IX_CellShips_FieldId",
                table: "CellShips",
                column: "FieldId");

            migrationBuilder.CreateIndex(
                name: "IX_CellShips_ShipId",
                table: "CellShips",
                column: "ShipId");
